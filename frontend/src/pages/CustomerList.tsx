...
export default function CustomerList() {
  ...
  const [customerInvoices, setCustomerInvoices] = useState<string[]>([]);
  ...
  const handleCreateInvoice = async (customer: Customer) => {
    ...
    setCustomerInvoices(prev => [...prev, customer.id]);
  };
            ...
            {customers.map((customer) => (
              <TableRow key={customer.id}>
                ...
                <TableCell align="right">
                  {customerInvoices.includes(customer.id) ? (
      ...
      >
        ...
        >
          <Typography variant="subtitle1">
            Customer {newCustomer.firstName} {newCustomer.surname} has been successfully created!
          </Typography>
        </Alert>
      </Snackbar>
    </Box>
