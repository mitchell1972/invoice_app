...
const InvoiceForm = () => {
    ...
    useEffect(() => {
        if (invoice) {
            ...
            try {
                ...
                console.error("Error parsing issue_date:", e);
            ...
            if (invoice.items && Array.isArray(invoice.items)) {
                ...
                // If no items, initialize with an empty one
                setItems([{
                    id: "1",
                    description: "",
                    quantity: 1,
    ...
    const updateInvoiceMutation = useMutation({
        ...
        onError: (error) => {
            console.error('Error in updateInvoiceMutation:', error);
    ...
    // Handler for issue date changes
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.log("Preparing to submit invoice update:", {
            ...
            console.log("Sending invoice update with data:", invoiceData);
            ...
            if (error.response) {
                ...
                alert(`Error: ${error.response.data?.detail || 'Unknown API error'}`);
